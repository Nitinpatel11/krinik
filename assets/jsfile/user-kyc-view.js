...
//     }
    ...
    //   }
    // }
    // document.getElementById("user-unlock")
    //   .addEventListener("click", () => lock());
    // // Event handlers for buttons
    // document.getElementById("user-transaction-history")
    //   .addEventListener("click", () =>
    //     redirectToHistoryPage("user-transaction-history")
    //   );
    // document.getElementById("user-game-history")
    //   .addEventListener("click", () =>
    //     redirectToHistoryPage("user-pool-history")
    //   );
    // document.getElementById("user-withdraw")
    //   .addEventListener("click", () =>
