...
data.forEach(league => {
const leagueEndDate = moment(league.end_league_date, 'DD-MM-YYYY').format('DD-MM-YYYY'); // Format league end date
console.log(leagueEndDate, "leagueEndDate");

// Compare the formatted currentDate and leagueEndDate
if (moment(currentDate, 'DD-MM-YYYY').isBefore(moment(leagueEndDate, 'DD-MM-YYYY'))) {
    const option = document.createElement('option');
